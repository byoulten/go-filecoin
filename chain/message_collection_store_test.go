...
func TestMessageCollectionStoreMessagesHappy(t *testing.T) {
	...
	ms := chain.NewMessageCollectionStore(hamt.NewCborStore())
...
func TestMessageCollectionStoreReceiptsHappy(t *testing.T) {
	ctx := context.Background()
